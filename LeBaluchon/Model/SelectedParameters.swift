...
final class SelectedParameters {
   ...
   static var selectedWeatherLeftCity = Weather(city: "", hour: "", description: "", icon: "", temperature: 0, feltTemperature: 0, pressure: 0, humidity: 0, windSpeed: 0, cloudiness: 0)
   ...
   static var selectedId = "\(firstSelectedId),\(secondSelectedId)"
   static var selectedLanguageToTranslate = "fr"
   static var selectedLanguageToObtain = "en"
   static var selectedTranslation = Translation(languageToTranslate: selectedLanguageToTranslate, languageToObtain: selectedLanguageToObtain, textToTranslate: "Bonjour", textToObtain: "Hello")
}
